...
function fillQuote() {
    ...
    linkedInFocusHTML += "<div style=\"border: 2px;border-style:solid;border-color:#434343;padding: 1em;width: 552px;height: 269px;margin-top: 20px;padding-top:2px;border-radius:4px;\">"
